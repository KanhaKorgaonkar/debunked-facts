...
export async function generateContent(year) {
  ...
  const prompt = `Provide a list of 10 scientific, historical, or widely accepted concepts that were considered factual or true in ${year} AND WERE TAUGHT IN SCHOOLS but have since been conclusively disproven or significantly revised. Return the results in the following JSON format:
